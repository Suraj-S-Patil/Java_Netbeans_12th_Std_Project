 ...
 * @author TEACHER
 */
public class CashWid extends javax.swing.JFrame {

    /**
     * Creates new form CashWid
     */
    public CashWid() {
        initComponents();
    }
...
try{
    ...
    String query="select Balance from project2 where Account_No="+s1+";";
    System.out.println("E4");
    ResultSet rs=stat.executeQuery(query);
    System.out.println("E5");
    rs.next();
    double s3=rs.getDouble("Balance");
    System.out.println("E6");
    if(s2<s3)
    {
        System.out.println(s2);
     String query2="update project2 set Balance=Balance-"+s2
                + " where Account_No="+s1+";";
    ...
    JOptionPane.showMessageDialog(this,"Please Collect Your Cash!");
        ...
        JOptionPane.showMessageDialog(this,"Your entered amount is greater than your balance amount!"
                +" Please enter another amount less than your balance Amount!");
...
jTextField2.setText(null);     // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashWid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
